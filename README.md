...
**Math Magicians** is React-based App for math fans. It showcases React, API interactivity, Jest testing and Redux.
...
```sh
  ...
  git clone git@github.com:lordksix/math-magic.git
```
